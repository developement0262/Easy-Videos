...
class Easy_Videos {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'ev_custom_post_type_video' );
		$this->loader->add_action( 'init', $plugin_admin, 'ev_custom_taxonomy_video' );

		// Easy video admin Menu
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'ev_admin_menu' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'ev_save_youtube_api' );
		
		// init ajax file
		$this->loader->add_action( 'wp_ajax_ev_easy_video_ajax', $plugin_admin, 'ev_easy_video_ajax' );
		$this->loader->add_action( 'init', $plugin_admin, 'ev_init_files' );
